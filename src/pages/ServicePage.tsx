...
const SERVICE_CONTENT: Record<ServicePageKey, ServiceContent> = {
  ogePrep: {
    ...
    intro: 'Подготовка к ОГЭ по английскому начинается с диагностики уровня и индивидуального плана. Разбираем формат экзамена, укрепляем языковую базу и регулярно тренируем устную и письменную части.',
    suitableFor: [
  ...
  egePrep: {
    ...
    intro: 'Системная подготовка к ЕГЭ по английскому: письменная и устная части, экзаменационная стратегия и контроль прогресса. Индивидуальный план учитывает текущий уровень, цель и время до экзамена.',
    suitableFor: [
  ...
  schoolEnglish: {
    eyebrow: '5–8 классы · индивидуальные онлайн-занятия',
    title: 'Английский для школьников 5–8 классов онлайн',
    intro: 'Помогаю улучшить оценки, закрыть пробелы в грамматике и увереннее говорить по-английски. Школьная программа, материалы и домашняя практика подбираются под уровень и цель ученика.',
    suitableFor: [
  ...
  teenSpeaking: {
    eyebrow: 'Подростки · разговорный английский',
    title: 'Английский для подростков онлайн',
    intro: 'Меньше страха, больше реальной речи и понятная грамматика. На индивидуальных онлайн-занятиях подросток учится выражать свои мысли, понимать английский на слух и увереннее вступать в диалог.',
    suitableFor: [
    ...
    related: [
      { page: 'schoolEnglish', label: 'Английский для школьников 5–8 классов', description: 'Поддержка по школьной программе, грамматике и домашним заданиям.' },
