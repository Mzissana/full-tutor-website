...
const GUIDES: Record<ToolGuideKey, GuideContent> = {
  monologue: {
    title: 'Как подготовить монолог ОГЭ',
    ...
    related: [{ page: 'speakPractice', label: 'Ответы на вопросы ОГЭ' }, { page: 'ogeElectronicLetter', label: 'Электронное письмо ОГЭ' }, { page: 'ogePrep', label: 'Подготовка к ОГЭ' }],
    officialSource: 'https://fipi.ru/oge/demoversii-specifikacii-kodifikatory',
  },
  questions: {
    title: 'Как тренировать ответы на вопросы ОГЭ',
    ...
    related: [{ page: 'ogeMonologue', label: 'Практика монологов ОГЭ' }, { page: 'examind', label: 'Лексические ментальные карты' }, { page: 'ogePrep', label: 'Подготовка к ОГЭ' }],
    officialSource: 'https://fipi.ru/oge/demoversii-specifikacii-kodifikatory',
  },
  letter: {
    title: 'Как написать электронное письмо ОГЭ',
    ...
    related: [{ page: 'ogeMonologue', label: 'Практика монологов ОГЭ' }, { page: 'speakPractice', label: 'Ответы на вопросы ОГЭ' }, { page: 'ogePrep', label: 'Подготовка к ОГЭ' }],
    officialSource: 'https://fipi.ru/oge/demoversii-specifikacii-kodifikatory',
  },
  mindmaps: {
